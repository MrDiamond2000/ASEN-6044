...
#include "tools/GraphContainers.hpp"
...
class Graph {
	...
	private:
		path_planning::RandomAccessList<path_planning::BidirectionalConnectionList<EDGE_T, NATIVE_NODE_T>> m_graph;
};
}

#include "tools/Graph_impl.hpp"